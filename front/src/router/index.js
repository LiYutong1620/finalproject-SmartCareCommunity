...
const ownerRoutes = {
  ...
  children: [
    ...
    { path: 'activity', component: () => import('@/views/owner/activity/index.vue'), meta: { title: '社区活动' } },
    { path: 'forum', component: () => import('@/views/owner/forum/index.vue'), meta: { title: '邻里话题' } },
    { path: 'visitor', component: () => import('@/views/owner/visitor/index.vue'), meta: { title: '访客预约' } },
    { path: 'family', component: () => import('@/views/owner/family/index.vue'), meta: { title: '亲情账号' } },
    { path: 'venue', component: () => import('@/views/owner/venue/index.vue'), meta: { title: '场地预约' } },
    { path: 'vote', component: () => import('@/views/owner/vote/index.vue'), meta: { title: '业主投票' } },
    { path: 'resident', component: () => import('@/views/owner/resident/index.vue'), meta: { title: '住户档案' } },
    { path: 'complaint', component: () => import('@/views/owner/complaint/index.vue'), meta: { title: '投诉建议' } },
    { path: 'bill', component: () => import('@/views/owner/bill/index.vue'), meta: { title: '缴费账单' } },
...
const propertyRoutes = {
  ...
  children: [
    ...
    { path: 'activity', component: () => import('@/views/property/activity/index.vue'), meta: { title: '活动管理' } },
    { path: 'complaint', component: () => import('@/views/property/complaint/index.vue'), meta: { title: '投诉管理' } },
    { path: 'forum', component: () => import('@/views/property/forum/index.vue'), meta: { title: '论坛审核' } },
    { path: 'bill', component: () => import('@/views/property/bill/index.vue'), meta: { title: '财务台账' } },
