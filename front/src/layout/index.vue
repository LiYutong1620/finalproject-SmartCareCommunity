...
const menuMap = {
  '0': [
    ...
    { path: '/owner/activity', title: '社区活动', icon: 'Calendar' },
    { path: '/owner/forum', title: '邻里话题', icon: 'ChatLineRound' },
    { path: '/owner/visitor', title: '访客预约', icon: 'Postcard' },
    { path: '/owner/family', title: '亲情账号', icon: 'Connection' },
    { path: '/owner/venue', title: '场地预约', icon: 'Place' },
    { path: '/owner/vote', title: '业主投票', icon: 'Finished' },
    { path: '/owner/resident', title: '住户档案', icon: 'User' },
    { path: '/owner/complaint', title: '投诉建议', icon: 'ChatDotRound' },
    { path: '/owner/bill', title: '缴费账单', icon: 'Wallet' },
  ...
  '2': [
    ...
    { path: '/property/activity', title: '活动管理', icon: 'Calendar' },
    { path: '/property/complaint', title: '投诉管理', icon: 'ChatDotRound' },
    { path: '/property/forum', title: '论坛审核', icon: 'ChatLineRound' },
    { path: '/property/bill', title: '财务台账', icon: 'Wallet' },
