  ...
  <div class="app-container">
    ...
    <el-card shadow="never" class="table-card">
      <el-table :data="list" v-loading="loading" border stripe>
        ...
        <el-table-column prop="restoreTime" label="预计恢复" width="170" align="center" />
...
async function fetchList() {
  loading.value = true
  try {
    const params = { pageNum: query.pageNum, pageSize: query.pageSize, noticeType: 'outage' }
...
function goDetail(row) {
  router.push({ path: `/owner/outage/detail/${row.noticeId}` })
}
